...
(function(){
  ...
  document.addEventListener('keydown',function(e){
    ...
    var sb=/google/i.test(host)?'https:
          :/bing/i.test(host)?'https:
          :/yahoo/i.test(host)?'https:
          :/ddg|duck/i.test(host)?'https:
          :'https:
    nav(sb+q);
  },true);
...
app.listen(PORT, () => {
  console.log(`EP Proxy server v2.3 running on http:
});
